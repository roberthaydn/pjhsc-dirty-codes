...
require_once 'UploadPortfolio.php';
...
<html lang="en">
  ...
  <body>
    <section class="portfolio">
      <div class="container">
          <div class="row">
              <form action="exams.php" method="post" enctype="multipart/form-data">
                  ...
                  <div class="upload-file">
                    ...
                    <input type="hidden" value="exams" name="portfolio">
        ...
        <div class="row">
            <table class="table">
                <th>File name</th><th>Type</th><th>Preview</th><th>Download</th>
                    <?= UploadController::Create()->read('exams'); ?>
            </table>
         </div>
      </div>
