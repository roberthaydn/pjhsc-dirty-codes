...
<body>
	...
	<div class="container">
		...
		<?php 
			...
			echo '<br><br><strong>Cookie Array (Json format)</strong><br>to view the activity of a cookie, navigate: inspect element->storage->cookies->http:://something<br><br><pre>';
